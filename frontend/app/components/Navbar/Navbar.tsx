        ...
        <div>
          <ul className="flex justify-center p-6 border-b-2 border-red-500">
             <li>
                ...
                <li>
                    <Link href="/Barometer"  className={`p-2 cursor-pointer transition-colors duration-300 ease-in-out ${
                  pathname === '/Barometer' ? 'text-red-500 border-b-2 border-red-500' : 'text-red-500 hover:text-red-900'
                }`}>
                    BAROMETER
                    </Link>
                </li>
